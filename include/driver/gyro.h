/**
 * @author: Dan
 * @since November 24, 2012, 6:05 PM
 * @version 1.0
 *
 * DESC
 */
...
#define gyMODULE I2C2 // The I2C port the gyro is connected to
#define gyADDR 0xD0 // I2C Address of the module
...
/**
 * Read a frame from the gyroscope
 * @param data The structure to save the gyroscope data into
 */
