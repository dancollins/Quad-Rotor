...
void gyro_read(GyroData_t * data) {
    ...
    /* X */
    x = (iic_getByte(gyMODULE, TRUE)<<8);
    x |= iic_getByte(gyMODULE, TRUE);

    /* Y */
    y = (iic_getByte(gyMODULE, TRUE)<<8);
    y |= iic_getByte(gyMODULE, TRUE);

    /* Z */
    z = (iic_getByte(gyMODULE, TRUE)<<8);
    z |= iic_getByte(gyMODULE, FALSE);
